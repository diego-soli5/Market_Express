...
async function getPaginatedPage(pgnum) {
    ...
    const url = `/Admin/Report/GetClientTable?${params}&PageNumber=${pgnum}`;
    ...
    try {
        ...
        document.querySelector("#divClientTable").innerHTML = text;
...
btnReport.addEventListener("click", function (e) {
    window.open(`/Admin/Report/ClientReport?${params}`, '_blank');
});
